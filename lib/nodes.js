(function() {
  ...
  exports.Base = Base = (function() {
    ...
    Base.prototype.typeAnnotation = function() {
      return this.typeAnnotation;
    };
  ...
  exports.Block = Block = (function() {
    ...
    Block.prototype.compileWithDeclarations = function(o) {
      ...
      var t;
      var i, name, _i, _len, _len2, _ref, _ref2;
      code = post = '';
      _ref = this.expressions;
        ...
        if (!o.globals && o.scope.hasDeclarations()) {
          ...
          for (_i = 0, _len2 = _ref2.length; _i < _len2; _i++) {
            ...
            if ((t.typeAnnotation != null)) {
              code += "" + this.tab + "/** @type {" + t.typeAnnotation + "} */\n";
  ...
  exports.Call = Call = (function() {
    ...
    Call.prototype.filterImplicitObjects = function(list) {
      ...
      var properties;
      var node, prop, _i, _j, _len, _len2, _ref;
      nodes = [];
  ...
  exports.Obj = Obj = (function() {
    ...
    Obj.prototype.compileNode = function(o) {
      ...
      var props;
      var i, indent, join, node, prop, _i, _len;
      props = this.properties;
      if (!props.length) {
        if (this.front) {
          return '({})';
  ...
  exports.Class = Class = (function() {
    ...
    Class.prototype.addBoundFunctions = function(o) {
      ...
      var bname;
      var bvar, _i, _len, _ref, _results;
  ...
  exports.Assign = Assign = (function() {
    ...
    Assign.prototype.compilePatternMatch = function(o) {
      ...
      var vvar;
      var i, _len, _ref, _ref2, _ref3, _ref4;
      top = o.level === LEVEL_TOP;
      value = this.value;
  ...
  exports.Code = Code = (function() {
    ...
    Code.prototype.compileNode = function(o) {
      ...
      var wasEmpty;
      var i, p, param, v, _i, _j, _len, _len2, _len3, _ref, _ref2, _ref3;
  ...
  exports.Switch = Switch = (function() {
    ...
    Switch.prototype.compileNode = function(o) {
      ...
      var _ref;
      var i, _i, _len, _len2, _ref2, _ref3, _ref4;
      idt1 = o.indent + TAB;
