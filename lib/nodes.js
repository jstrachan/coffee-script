(function() {
  ...
  exports.Base = Base = (function() {
    ...
    Base.prototype.typeAnnotation = null;
  ...
  exports.Assign = Assign = (function() {
    ...
    Assign.prototype.compileNode = function(o) {
      ...
      if (!(this.context || isValue && (this.variable.namespaced || this.variable.hasProperties()))) {
        if (this.param) {
          if (this.variable instanceof Value && this.variable.typeAnnotation !== null) {
            console.log("Found variable " + name + " of type " + this.variable.typeAnnotation);
          }
